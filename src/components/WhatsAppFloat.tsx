...
const WhatsAppFloat = () => {
    ...
    const phoneNumber = "+919599840666"
    ...
    return (
        <div className="fixed bottom-6 right-6 z-50">
            <button
                ...
                className="group relative bg-[#25d366] hover:bg-[#20b954] text-white rounded-full p-4 shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-110 focus:outline-none focus:ring-4 focus:ring-[#25d366] focus:ring-opacity-50"
            ...
            >
                ...
                <svg
                    ...
                    viewBox="0 0 24 24"
                    fill="#FFFFFF"
                    className="transition-transform z-10 duration-300 group-hover:rotate-12"
                >
